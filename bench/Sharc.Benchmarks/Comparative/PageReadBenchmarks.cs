...
public class PageReadBenchmarks
{
    ...
    private MemoryMappedPageSource _mmapSource = null!;
    ...
    public void Setup()
    {
        ...
        _dbPath = TestDatabaseGenerator.CreateMediumDatabase(dir);
        ...
        _mmapSource = new MemoryMappedPageSource(_dbPath);
    ...
    // --- Sharc: FilePageSource (RandomAccess — one syscall per page read) ---
