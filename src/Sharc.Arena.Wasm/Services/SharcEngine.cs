...
/// </summary>
public sealed class SharcEngine
{
    ...
    /// Returns engine-load timing if this is the first call.
    /// </summary>
    public (double Ms, long AllocBytes) EnsureInitialized(int userCount, int nodeCount)
    {
